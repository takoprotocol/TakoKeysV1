...
export const JamfrensKeysV1Abi = [
  {
    inputs: [
      {
  ...
  {
    inputs: [],
    name: "jamfrensLensKey",
    outputs: [
      {
        internalType: "contract IJamfrensLensKey",
        name: "",
        type: "address",
      },
    ],
